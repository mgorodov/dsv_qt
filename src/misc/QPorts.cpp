...
Message::Message(QObject* address, const std::any& data) : QEvent(type()), address_(address), data_(data) {}

Message::Message(QObject* address, std::any&& data) : QEvent(type()), address_(address), data_(std::move(data)) {}
...
void QSender::send(QObject* receiver, std::any data) const {
    QCoreApplication::postEvent(QCoreApplication::instance(), new Message(receiver, std::move(data)));
}
